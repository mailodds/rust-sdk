...
> models::GetReplyForwarding200Response get_reply_forwarding(domain_id)
...
[**models::GetReplyForwarding200Response**](getReplyForwarding_200_response.md)
...
> models::GetReplyForwarding200Response update_reply_forwarding(domain_id, update_reply_forwarding_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**domain_id** | **String** | Sending domain ID | [required] |
**update_reply_forwarding_request** | [**UpdateReplyForwardingRequest**](UpdateReplyForwardingRequest.md) |  | [required] |
