...
pub struct AppendToContactList200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "contact_list", skip_serializing_if = "Option::is_none")]
    pub contact_list: Option<Box<models::ContactList>>,
...
impl AppendToContactList200Response {
    pub fn new() -> AppendToContactList200Response {
