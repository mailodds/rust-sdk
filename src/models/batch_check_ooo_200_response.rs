...
pub struct BatchCheckOoo200Response {
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<models::BatchCheckOoo200ResponseResultsInner>>,
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
    #[serde(rename = "ooo_count", skip_serializing_if = "Option::is_none")]
    pub ooo_count: Option<i32>,
}

impl BatchCheckOoo200Response {
    pub fn new() -> BatchCheckOoo200Response {
