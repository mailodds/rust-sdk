...
pub struct BatchProductsRequest {
    ...
    pub products: Vec<models::BatchProductsRequestProductsInner>,
}

impl BatchProductsRequest {
    pub fn new(products: Vec<models::BatchProductsRequestProductsInner>) -> BatchProductsRequest {
