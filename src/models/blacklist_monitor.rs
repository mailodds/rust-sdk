...
pub struct BlacklistMonitor {
    ...
    #[serde(rename = "listed_count", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "latest_check", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub latest_check: Option<Option<Box<models::BlacklistMonitorLatestCheck>>>,
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
}

impl BlacklistMonitor {
    pub fn new() -> BlacklistMonitor {
        BlacklistMonitor {
            id: None,
            target: None,
            target_type: None,
