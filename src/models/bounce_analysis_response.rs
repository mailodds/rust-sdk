...
pub struct BounceAnalysisResponse {
    ...
    pub analysis: Option<Box<models::BounceAnalysisResponseAnalysis>>,
}

impl BounceAnalysisResponse {
    pub fn new() -> BounceAnalysisResponse {
