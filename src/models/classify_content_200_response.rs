...
pub struct ClassifyContent200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "content_check", skip_serializing_if = "Option::is_none")]
    pub content_check: Option<Box<models::ClassifyContent200ResponseContentCheck>>,
}

impl ClassifyContent200Response {
    pub fn new() -> ClassifyContent200Response {
