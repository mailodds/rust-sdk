...
pub struct CreateCampaignVariant201Response {
    ...
    pub variant: Option<Box<models::CampaignVariant>>,
}

impl CreateCampaignVariant201Response {
    pub fn new() -> CreateCampaignVariant201Response {
