...
pub struct CreateContactListRequest {
    ...
    #[serde(rename = "source_job_id", skip_serializing_if = "Option::is_none")]
    pub source_job_id: Option<String>,
    /// Multiple validation job IDs to merge into one list
    #[serde(rename = "source_job_ids", skip_serializing_if = "Option::is_none")]
    pub source_job_ids: Option<Vec<String>>,
...
impl CreateContactListRequest {
    pub fn new(name: String) -> CreateContactListRequest {
