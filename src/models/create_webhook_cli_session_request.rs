...
pub struct CreateWebhookCliSessionRequest {
    /// Local URL where webhooks will be forwarded
    #[serde(rename = "forward_url", skip_serializing_if = "Option::is_none")]
    pub forward_url: Option<String>,
}

impl CreateWebhookCliSessionRequest {
    pub fn new() -> CreateWebhookCliSessionRequest {
