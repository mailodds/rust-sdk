...
pub struct CrossReferenceBounces200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "cross_reference", skip_serializing_if = "Option::is_none")]
    pub cross_reference: Option<Box<models::CrossReferenceBounces200ResponseCrossReference>>,
}

impl CrossReferenceBounces200Response {
    pub fn new() -> CrossReferenceBounces200Response {
