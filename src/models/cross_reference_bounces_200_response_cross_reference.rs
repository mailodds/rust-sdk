...
pub struct CrossReferenceBounces200ResponseCrossReference {
    #[serde(rename = "total_bounced", skip_serializing_if = "Option::is_none")]
    pub total_bounced: Option<i32>,
    ...
    #[serde(rename = "match_rate", skip_serializing_if = "Option::is_none")]
    pub match_rate: Option<f64>,
    #[serde(rename = "entries", skip_serializing_if = "Option::is_none")]
    pub entries: Option<Vec<models::CrossReferenceBounces200ResponseCrossReferenceEntriesInner>>,
}

impl CrossReferenceBounces200ResponseCrossReference {
    pub fn new() -> CrossReferenceBounces200ResponseCrossReference {
