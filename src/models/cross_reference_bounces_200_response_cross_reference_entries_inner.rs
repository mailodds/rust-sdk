...
pub struct CrossReferenceBounces200ResponseCrossReferenceEntriesInner {
    #[serde(rename = "email", skip_serializing_if = "Option::is_none")]
    pub email: Option<String>,
    #[serde(rename = "bounce_type", skip_serializing_if = "Option::is_none")]
    pub bounce_type: Option<String>,
    #[serde(rename = "bounced_at", skip_serializing_if = "Option::is_none")]
    pub bounced_at: Option<String>,
    #[serde(rename = "validation_status", skip_serializing_if = "Option::is_none")]
    pub validation_status: Option<String>,
    #[serde(rename = "validated_at", skip_serializing_if = "Option::is_none")]
    pub validated_at: Option<String>,
}

impl CrossReferenceBounces200ResponseCrossReferenceEntriesInner {
    pub fn new() -> CrossReferenceBounces200ResponseCrossReferenceEntriesInner {
