...
pub struct DeliverRequestOptions {
    /// Validate recipients before sending
    #[serde(rename = "validate_first", skip_serializing_if = "Option::is_none")]
    pub validate_first: Option<bool>,
}

impl DeliverRequestOptions {
    pub fn new() -> DeliverRequestOptions {
