...
pub struct DeliverResponse {
    ...
    pub delivery: Option<Box<models::DeliverResponseDelivery>>,
    ...
    #[serde(rename = "content_scan", skip_serializing_if = "Option::is_none")]
    pub content_scan: Option<serde_json::Value>,
}
