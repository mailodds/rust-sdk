...
pub struct DeliverResponseDelivery {
    /// IP pool used
    ...
    #[serde(rename = "warmup_limited", skip_serializing_if = "Option::is_none")]
    pub warmup_limited: Option<bool>,
}

impl DeliverResponseDelivery {
    pub fn new() -> DeliverResponseDelivery {
