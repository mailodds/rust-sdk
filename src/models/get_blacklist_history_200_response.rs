...
pub struct GetBlacklistHistory200Response {
    ...
    pub checks: Option<Vec<models::GetBlacklistHistory200ResponseChecksInner>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl GetBlacklistHistory200Response {
    pub fn new() -> GetBlacklistHistory200Response {
