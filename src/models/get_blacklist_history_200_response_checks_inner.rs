...
pub struct GetBlacklistHistory200ResponseChecksInner {
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(rename = "listed_on", skip_serializing_if = "Option::is_none")]
    pub listed_on: Option<Vec<String>>,
    #[serde(rename = "clean_on", skip_serializing_if = "Option::is_none")]
    pub clean_on: Option<Vec<String>>,
    #[serde(rename = "checked_at", skip_serializing_if = "Option::is_none")]
    pub checked_at: Option<String>,
}

impl GetBlacklistHistory200ResponseChecksInner {
    pub fn new() -> GetBlacklistHistory200ResponseChecksInner {
