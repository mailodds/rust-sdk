...
pub struct GetBounceRecords200Response {
    ...
    pub records: Option<Vec<models::GetBounceRecords200ResponseRecordsInner>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl GetBounceRecords200Response {
    pub fn new() -> GetBounceRecords200Response {
