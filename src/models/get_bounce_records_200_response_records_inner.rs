...
pub struct GetBounceRecords200ResponseRecordsInner {
    ...
    #[serde(rename = "enhanced_status", skip_serializing_if = "Option::is_none")]
...
impl GetBounceRecords200ResponseRecordsInner {
    pub fn new() -> GetBounceRecords200ResponseRecordsInner {
