...
pub struct GetCampaignAbResults200Response {
    ...
    pub variants: Option<Vec<models::GetCampaignAbResults200ResponseVariantsInner>>,
    #[serde(rename = "winner", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub winner: Option<Option<Box<models::GetCampaignAbResults200ResponseWinner>>>,
}

impl GetCampaignAbResults200Response {
    pub fn new() -> GetCampaignAbResults200Response {
