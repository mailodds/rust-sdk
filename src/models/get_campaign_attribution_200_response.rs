...
pub struct GetCampaignAttribution200Response {
    ...
    pub attribution: Option<Box<models::GetCampaignAttribution200ResponseAttribution>>,
}

impl GetCampaignAttribution200Response {
    pub fn new() -> GetCampaignAttribution200Response {
