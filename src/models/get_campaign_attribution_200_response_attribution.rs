...
pub struct GetCampaignAttribution200ResponseAttribution {
    #[serde(rename = "first_touch", skip_serializing_if = "Option::is_none")]
    pub first_touch: Option<Box<models::GetCampaignAttribution200ResponseAttributionFirstTouch>>,
    #[serde(rename = "last_touch", skip_serializing_if = "Option::is_none")]
    pub last_touch: Option<Box<models::GetCampaignAttribution200ResponseAttributionFirstTouch>>,
}

impl GetCampaignAttribution200ResponseAttribution {
    pub fn new() -> GetCampaignAttribution200ResponseAttribution {
