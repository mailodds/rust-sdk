...
pub struct GetCampaignDeliveryConfidence200ResponseFactors {
    #[serde(rename = "list_quality", skip_serializing_if = "Option::is_none")]
    pub list_quality: Option<Box<models::GetCampaignDeliveryConfidence200ResponseFactorsListQuality>>,
    #[serde(rename = "sender_reputation", skip_serializing_if = "Option::is_none")]
    pub sender_reputation: Option<Box<models::GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation>>,
    #[serde(rename = "domain_auth", skip_serializing_if = "Option::is_none")]
    pub domain_auth: Option<Box<models::GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth>>,
}

impl GetCampaignDeliveryConfidence200ResponseFactors {
    pub fn new() -> GetCampaignDeliveryConfidence200ResponseFactors {
