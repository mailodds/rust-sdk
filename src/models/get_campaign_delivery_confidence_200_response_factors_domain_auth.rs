...
pub struct GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth {
...
impl GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth {
    pub fn new() -> GetCampaignDeliveryConfidence200ResponseFactorsDomainAuth {
