...
pub struct GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    #[serde(rename = "score", skip_serializing_if = "Option::is_none")]
    pub score: Option<i32>,
    #[serde(rename = "total_recipients", skip_serializing_if = "Option::is_none")]
    pub total_recipients: Option<i32>,
    #[serde(rename = "validated_pct", skip_serializing_if = "Option::is_none")]
    pub validated_pct: Option<f64>,
    #[serde(rename = "suppressed_count", skip_serializing_if = "Option::is_none")]
    pub suppressed_count: Option<i32>,
}

impl GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    pub fn new() -> GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
