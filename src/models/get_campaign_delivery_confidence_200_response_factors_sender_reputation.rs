...
pub struct GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation {
    #[serde(rename = "score", skip_serializing_if = "Option::is_none")]
    pub score: Option<i32>,
    #[serde(rename = "recent_bounce_rate", skip_serializing_if = "Option::is_none")]
    pub recent_bounce_rate: Option<f64>,
    #[serde(rename = "recent_complaint_rate", skip_serializing_if = "Option::is_none")]
    pub recent_complaint_rate: Option<f64>,
}

impl GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation {
    pub fn new() -> GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation {
        GetCampaignDeliveryConfidence200ResponseFactorsSenderReputation {
            score: None,
            recent_bounce_rate: None,
            recent_complaint_rate: None,
        }
    }
}
