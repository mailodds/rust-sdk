...
pub struct GetCampaignFunnel200Response {
    ...
    pub funnel: Option<Box<models::GetCampaignFunnel200ResponseFunnel>>,
    #[serde(rename = "rates", skip_serializing_if = "Option::is_none")]
    pub rates: Option<Box<models::GetCampaignFunnel200ResponseRates>>,
}

impl GetCampaignFunnel200Response {
    pub fn new() -> GetCampaignFunnel200Response {
