...
pub struct GetCampaignFunnel200ResponseRates {
    ...
    #[serde(rename = "click_to_open_rate", skip_serializing_if = "Option::is_none")]
    pub click_to_open_rate: Option<f64>,
    #[serde(rename = "bounce_rate", skip_serializing_if = "Option::is_none")]
    pub bounce_rate: Option<f64>,
    #[serde(rename = "unsubscribe_rate", skip_serializing_if = "Option::is_none")]
...
impl GetCampaignFunnel200ResponseRates {
    pub fn new() -> GetCampaignFunnel200ResponseRates {
