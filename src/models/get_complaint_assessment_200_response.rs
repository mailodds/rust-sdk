...
pub struct GetComplaintAssessment200Response {
    ...
    #[serde(rename = "total_complaints", skip_serializing_if = "Option::is_none")]
    pub total_complaints: Option<i32>,
    #[serde(rename = "total_sent", skip_serializing_if = "Option::is_none")]
    pub total_sent: Option<i32>,
}

impl GetComplaintAssessment200Response {
    pub fn new() -> GetComplaintAssessment200Response {
