...
pub struct GetDisengagedContacts200Response {
    ...
    pub pagination: Option<Box<models::GetDisengagedContacts200ResponsePagination>>,
}

impl GetDisengagedContacts200Response {
    pub fn new() -> GetDisengagedContacts200Response {
