...
pub struct GetDmarcDomain200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "domain", skip_serializing_if = "Option::is_none")]
    pub domain: Option<Box<models::GetDmarcDomain200ResponseDomain>>,
}

impl GetDmarcDomain200Response {
    pub fn new() -> GetDmarcDomain200Response {
