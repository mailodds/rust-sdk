...
pub struct GetDmarcDomain200ResponseDomain {
    /// Domain UUID
    ...
    #[serde(rename = "reporting_address", skip_serializing_if = "Option::is_none")]
    pub reporting_address: Option<String>,
    /// Whether DNS record has been verified
    #[serde(rename = "dns_verified", skip_serializing_if = "Option::is_none")]
    pub dns_verified: Option<bool>,
    #[serde(rename = "dns_verified_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub dns_verified_at: Option<Option<String>>,
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "summary", skip_serializing_if = "Option::is_none")]
    pub summary: Option<Box<models::GetDmarcDomain200ResponseDomainAllOfSummary>>,
}

impl GetDmarcDomain200ResponseDomain {
    pub fn new() -> GetDmarcDomain200ResponseDomain {
