...
pub struct GetDmarcRecommendation200Response {
    ...
    pub recommendation: Option<Box<models::GetDmarcRecommendation200ResponseRecommendation>>,
}

impl GetDmarcRecommendation200Response {
    pub fn new() -> GetDmarcRecommendation200Response {
