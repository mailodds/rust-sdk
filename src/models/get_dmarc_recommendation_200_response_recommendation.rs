...
pub struct GetDmarcRecommendation200ResponseRecommendation {
    /// Current DMARC policy (none, quarantine, reject)
    #[serde(rename = "current_policy", skip_serializing_if = "Option::is_none")]
    pub current_policy: Option<String>,
    /// Recommended DMARC policy
    #[serde(rename = "recommended_policy", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ready_to_upgrade", skip_serializing_if = "Option::is_none")]
    pub ready_to_upgrade: Option<bool>,
}

impl GetDmarcRecommendation200ResponseRecommendation {
    pub fn new() -> GetDmarcRecommendation200ResponseRecommendation {
        GetDmarcRecommendation200ResponseRecommendation {
            current_policy: None,
            recommended_policy: None,
            confidence: None,
            reasons: None,
            ready_to_upgrade: None,
        }
    }
}
