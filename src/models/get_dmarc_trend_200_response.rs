...
pub struct GetDmarcTrend200Response {
    ...
    pub trend: Option<Vec<models::GetDmarcTrend200ResponseTrendInner>>,
}

impl GetDmarcTrend200Response {
    pub fn new() -> GetDmarcTrend200Response {
