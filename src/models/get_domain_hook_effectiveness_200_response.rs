...
pub struct GetDomainHookEffectiveness200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "effectiveness", skip_serializing_if = "Option::is_none")]
    pub effectiveness: Option<serde_json::Value>,
}

impl GetDomainHookEffectiveness200Response {
    pub fn new() -> GetDomainHookEffectiveness200Response {
