...
pub struct GetDomainInsightsTrends200Response {
    ...
    pub trends: Option<Vec<serde_json::Value>>,
}

impl GetDomainInsightsTrends200Response {
    pub fn new() -> GetDomainInsightsTrends200Response {
