...
pub struct GetEngagementScore200Response {
    ...
    #[serde(rename = "last_engaged_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub last_engaged_at: Option<Option<String>>,
}

impl GetEngagementScore200Response {
    pub fn new() -> GetEngagementScore200Response {
