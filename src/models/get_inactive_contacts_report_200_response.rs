...
pub struct GetInactiveContactsReport200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "inactive_count", skip_serializing_if = "Option::is_none")]
    pub inactive_count: Option<i32>,
    #[serde(rename = "total_contacts", skip_serializing_if = "Option::is_none")]
    pub total_contacts: Option<i32>,
    #[serde(rename = "inactive_rate", skip_serializing_if = "Option::is_none")]
    pub inactive_rate: Option<f64>,
    #[serde(rename = "by_list", skip_serializing_if = "Option::is_none")]
    pub by_list: Option<Vec<models::GetInactiveContactsReport200ResponseByListInner>>,
}

impl GetInactiveContactsReport200Response {
    pub fn new() -> GetInactiveContactsReport200Response {
