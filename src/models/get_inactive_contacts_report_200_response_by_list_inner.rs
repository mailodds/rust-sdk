...
pub struct GetInactiveContactsReport200ResponseByListInner {
    #[serde(rename = "list_id", skip_serializing_if = "Option::is_none")]
    pub list_id: Option<String>,
    #[serde(rename = "list_name", skip_serializing_if = "Option::is_none")]
...
impl GetInactiveContactsReport200ResponseByListInner {
    pub fn new() -> GetInactiveContactsReport200ResponseByListInner {
