...
pub struct GetMessageEvents200Response {
    ...
    pub summary: Option<Box<models::GetMessageEvents200ResponseSummary>>,
    #[serde(rename = "clicks", skip_serializing_if = "Option::is_none")]
    pub clicks: Option<Vec<models::GetMessageEvents200ResponseClicksInner>>,
    #[serde(rename = "events", skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<models::GetMessageEvents200ResponseEventsInner>>,
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl GetMessageEvents200Response {
    pub fn new() -> GetMessageEvents200Response {
