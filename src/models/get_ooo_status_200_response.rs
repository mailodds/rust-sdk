...
pub struct GetOooStatus200Response {
    #[serde(rename = "email", skip_serializing_if = "Option::is_none")]
    pub email: Option<String>,
    #[serde(rename = "is_ooo", skip_serializing_if = "Option::is_none")]
    pub is_ooo: Option<bool>,
    #[serde(rename = "detected_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ooo_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub ooo_type: Option<Option<String>>,
}

impl GetOooStatus200Response {
    pub fn new() -> GetOooStatus200Response {
