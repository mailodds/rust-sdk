...
pub struct GetPixelSettings200Response {
    #[serde(rename = "pixel_uuid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pixel_uuid: Option<Option<String>>,
    #[serde(rename = "pixel_subscribe_list_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pixel_subscribe_list_id: Option<Option<i32>>,
}

impl GetPixelSettings200Response {
    pub fn new() -> GetPixelSettings200Response {
        GetPixelSettings200Response {
            pixel_uuid: None,
            pixel_subscribe_list_id: None,
        }
    }
}
