...
pub struct GetSenderHealth200ResponseComponents {
    #[serde(rename = "delivery_rate", skip_serializing_if = "Option::is_none")]
    pub delivery_rate: Option<Box<models::GetSenderHealth200ResponseComponentsDeliveryRate>>,
    #[serde(rename = "bounce_rate", skip_serializing_if = "Option::is_none")]
    pub bounce_rate: Option<Box<models::GetSenderHealth200ResponseComponentsDeliveryRate>>,
    #[serde(rename = "complaint_rate", skip_serializing_if = "Option::is_none")]
    pub complaint_rate: Option<Box<models::GetSenderHealth200ResponseComponentsDeliveryRate>>,
    #[serde(rename = "authentication", skip_serializing_if = "Option::is_none")]
    pub authentication: Option<Box<models::GetSenderHealth200ResponseComponentsDeliveryRate>>,
}

impl GetSenderHealth200ResponseComponents {
    pub fn new() -> GetSenderHealth200ResponseComponents {
