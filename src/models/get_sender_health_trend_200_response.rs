...
pub struct GetSenderHealthTrend200Response {
    ...
    #[serde(rename = "data_points", skip_serializing_if = "Option::is_none")]
    pub data_points: Option<Vec<models::GetSenderHealthTrend200ResponseDataPointsInner>>,
}

impl GetSenderHealthTrend200Response {
    pub fn new() -> GetSenderHealthTrend200Response {
