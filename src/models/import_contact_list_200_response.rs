...
pub struct ImportContactList200Response {
    ...
    pub contact_list: Option<serde_json::Value>,
}

impl ImportContactList200Response {
    pub fn new() -> ImportContactList200Response {
