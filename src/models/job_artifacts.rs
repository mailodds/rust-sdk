...
/// JobArtifacts : Download URLs for completed jobs. Present only when status is completed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct JobArtifacts {
    /// CSV with all results
    #[serde(rename = "csv_all", skip_serializing_if = "Option::is_none")]
    pub csv_all: Option<String>,
    /// CSV with valid emails only
    #[serde(rename = "csv_valid", skip_serializing_if = "Option::is_none")]
    pub csv_valid: Option<String>,
    /// CSV with invalid emails only
    #[serde(rename = "csv_invalid", skip_serializing_if = "Option::is_none")]
    pub csv_invalid: Option<String>,
}

impl JobArtifacts {
    /// Download URLs for completed jobs. Present only when status is completed.
    pub fn new() -> JobArtifacts {
        JobArtifacts {
            csv_all: None,
            csv_valid: None,
            csv_invalid: None,
