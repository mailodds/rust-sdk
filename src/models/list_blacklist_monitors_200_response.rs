...
pub struct ListBlacklistMonitors200Response {
    ...
    pub monitors: Option<Vec<models::BlacklistMonitor>>,
}

impl ListBlacklistMonitors200Response {
    pub fn new() -> ListBlacklistMonitors200Response {
