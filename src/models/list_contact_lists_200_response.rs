...
pub struct ListContactLists200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "contact_lists", skip_serializing_if = "Option::is_none")]
    pub contact_lists: Option<Vec<models::ContactList>>,
...
impl ListContactLists200Response {
    pub fn new() -> ListContactLists200Response {
