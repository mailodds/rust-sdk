...
pub struct ListSpamChecks200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "spam_checks", skip_serializing_if = "Option::is_none")]
    pub spam_checks: Option<Vec<models::SpamCheck>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl ListSpamChecks200Response {
    pub fn new() -> ListSpamChecks200Response {
