...
pub struct ListSyncJobs200Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "sync_jobs", skip_serializing_if = "Option::is_none")]
    pub sync_jobs: Option<Vec<serde_json::Value>>,
...
impl ListSyncJobs200Response {
    pub fn new() -> ListSyncJobs200Response {
