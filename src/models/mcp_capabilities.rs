...
pub struct McpCapabilities {
    ...
    #[serde(rename = "pillars", skip_serializing_if = "Option::is_none")]
    pub pillars: Option<Vec<models::McpCapabilitiesPillarsInner>>,
    #[serde(rename = "supported_transports", skip_serializing_if = "Option::is_none")]
    pub supported_transports: Option<Vec<String>>,
    #[serde(rename = "auth_required", skip_serializing_if = "Option::is_none")]
