...
pub struct McpCapabilitiesPillarsInner {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "tool_count", skip_serializing_if = "Option::is_none")]
    pub tool_count: Option<i32>,
    #[serde(rename = "tools", skip_serializing_if = "Option::is_none")]
    pub tools: Option<Vec<models::McpCapabilitiesPillarsInnerToolsInner>>,
}

impl McpCapabilitiesPillarsInner {
    pub fn new() -> McpCapabilitiesPillarsInner {
