...
pub struct McpCapabilitiesPillarsInnerToolsInner {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// OAuth scope required to use this tool
    #[serde(rename = "required_scope", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub required_scope: Option<Option<String>>,
}

impl McpCapabilitiesPillarsInnerToolsInner {
    pub fn new() -> McpCapabilitiesPillarsInnerToolsInner {
