...
pub struct OAuthServerMetadata {
    ...
    #[serde(rename = "revocation_endpoint_auth_methods_supported", skip_serializing_if = "Option::is_none")]
    pub revocation_endpoint_auth_methods_supported: Option<Vec<String>>,
    #[serde(rename = "introspection_endpoint_auth_methods_supported", skip_serializing_if = "Option::is_none")]
    pub introspection_endpoint_auth_methods_supported: Option<Vec<String>>,
}

impl OAuthServerMetadata {
    /// OAuth 2.0 Authorization Server Metadata (RFC 8414)
    pub fn new() -> OAuthServerMetadata {
        OAuthServerMetadata {
            issuer: None,
