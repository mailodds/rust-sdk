...
pub struct ProductFacets {
    ...
    pub categories: Option<Vec<models::ProductFacetsCategoriesInner>>,
    #[serde(rename = "price_ranges", skip_serializing_if = "Option::is_none")]
    pub price_ranges: Option<Vec<models::ProductFacetsPriceRangesInner>>,
    #[serde(rename = "stores", skip_serializing_if = "Option::is_none")]
    pub stores: Option<Vec<models::ProductFacetsStoresInner>>,
}

impl ProductFacets {
    /// Aggregated facets for the current query filters
    pub fn new() -> ProductFacets {
        ProductFacets {
            categories: None,
            price_ranges: None,
            stores: None,
