...
pub struct QueryContactList200Response {
    ...
    pub emails: Option<Vec<models::QueryContactList200ResponseEmailsInner>>,
...
impl QueryContactList200Response {
    pub fn new() -> QueryContactList200Response {
