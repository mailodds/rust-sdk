...
pub struct QueryContactListRequest {
    /// Array of filter conditions
    #[serde(rename = "filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<Vec<models::QueryContactListRequestFiltersInner>>,
...
impl QueryContactListRequest {
    pub fn new() -> QueryContactListRequest {
