...
pub struct QueryProducts200Response {
    ...
    pub products: Option<Vec<models::StoreProduct>>,
    ...
    pub facets: Option<Box<models::ProductFacets>>,
}

impl QueryProducts200Response {
    pub fn new() -> QueryProducts200Response {
