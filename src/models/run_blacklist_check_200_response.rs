...
pub struct RunBlacklistCheck200Response {
    ...
    pub monitor: Option<Box<models::BlacklistMonitor>>,
    #[serde(rename = "check", skip_serializing_if = "Option::is_none")]
    pub check: Option<Box<models::RunBlacklistCheck200ResponseCheck>>,
}

impl RunBlacklistCheck200Response {
    pub fn new() -> RunBlacklistCheck200Response {
