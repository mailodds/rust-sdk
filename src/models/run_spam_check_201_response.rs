...
pub struct RunSpamCheck201Response {
    #[serde(rename = "schema_version", skip_serializing_if = "Option::is_none")]
    pub schema_version: Option<String>,
    #[serde(rename = "request_id", skip_serializing_if = "Option::is_none")]
    pub request_id: Option<String>,
    #[serde(rename = "spam_check", skip_serializing_if = "Option::is_none")]
    pub spam_check: Option<Box<models::SpamCheck>>,
}

impl RunSpamCheck201Response {
    pub fn new() -> RunSpamCheck201Response {
