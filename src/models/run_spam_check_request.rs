...
pub struct RunSpamCheckRequest {
    /// Sending domain to check
    #[serde(rename = "from_domain")]
    pub from_domain: String,
    /// URLs included in the email
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Vec<String>>,
    /// Email subject line to analyze
    #[serde(rename = "subject_preview", skip_serializing_if = "Option::is_none")]
    pub subject_preview: Option<String>,
    /// Client-side spam scores to include in analysis
    #[serde(rename = "client_scores", skip_serializing_if = "Option::is_none")]
    pub client_scores: Option<serde_json::Value>,
}

impl RunSpamCheckRequest {
    pub fn new(from_domain: String) -> RunSpamCheckRequest {
        RunSpamCheckRequest {
            from_domain,
            links: None,
