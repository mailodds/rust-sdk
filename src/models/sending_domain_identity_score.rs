...
pub struct SendingDomainIdentityScore {
    ...
    pub breakdown: Box<models::SendingDomainIdentityScoreBreakdown>,
    /// Letter grade (A+, A, B, C, D, F)
    #[serde(rename = "grade")]
    pub grade: Grade,
}

impl SendingDomainIdentityScore {
    pub fn new(score: i32, max_score: i32, percentage: i32, breakdown: models::SendingDomainIdentityScoreBreakdown, grade: Grade) -> SendingDomainIdentityScore {
