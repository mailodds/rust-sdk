...
/// SpamCheckChecks : Individual check results
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpamCheckChecks {
    #[serde(rename = "domain_reputation", skip_serializing_if = "Option::is_none")]
    pub domain_reputation: Option<serde_json::Value>,
    #[serde(rename = "link_safety", skip_serializing_if = "Option::is_none")]
    pub link_safety: Option<serde_json::Value>,
    #[serde(rename = "subject_analysis", skip_serializing_if = "Option::is_none")]
    pub subject_analysis: Option<serde_json::Value>,
}

impl SpamCheckChecks {
    /// Individual check results
    pub fn new() -> SpamCheckChecks {
        SpamCheckChecks {
