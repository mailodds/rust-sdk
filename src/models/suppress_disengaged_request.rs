...
pub struct SuppressDisengagedRequest {
    /// Days of inactivity threshold
    #[serde(rename = "inactive_days", skip_serializing_if = "Option::is_none")]
    pub inactive_days: Option<i32>,
    /// Minimum sends to qualify
    #[serde(rename = "min_sends", skip_serializing_if = "Option::is_none")]
    pub min_sends: Option<i32>,
    /// Preview without suppressing
    #[serde(rename = "dry_run", skip_serializing_if = "Option::is_none")]
    pub dry_run: Option<bool>,
}

impl SuppressDisengagedRequest {
    pub fn new() -> SuppressDisengagedRequest {
