...
pub struct SuppressionAuditResponse {
    ...
    pub entries: Option<Vec<models::SuppressionAuditResponseEntriesInner>>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<Box<models::Pagination>>,
}

impl SuppressionAuditResponse {
    pub fn new() -> SuppressionAuditResponse {
