...
impl TrackEventRequest {
    pub fn new(event_type: EventType, email: String) -> TrackEventRequest {
        TrackEventRequest {
            event_type,
            email,
            properties: None,
...
pub enum EventType {
    ...
    #[serde(rename = "review")]
    Review,
    #[serde(rename = "shadow_dns_dwell")]
    ShadowDnsDwell,
    #[serde(rename = "css_probe")]
    CssProbe,
    #[serde(rename = "identity_stitch")]
    IdentityStitch,
}
