...
pub struct UpdateOooContactRequest {
    /// Set to false to clear OOO status
    #[serde(rename = "is_active", skip_serializing_if = "Option::is_none")]
    pub is_active: Option<bool>,
    #[serde(rename = "ooo_type", skip_serializing_if = "Option::is_none")]
    pub ooo_type: Option<String>,
    #[serde(rename = "duration_days", skip_serializing_if = "Option::is_none")]
    pub duration_days: Option<i32>,
}

impl UpdateOooContactRequest {
    pub fn new() -> UpdateOooContactRequest {
