...
pub struct UpdatePixelSettingsRequest {
    /// Contact list ID for pixel subscriptions, or null to disable
    #[serde(rename = "pixel_subscribe_list_id", deserialize_with = "Option::deserialize")]
    pub pixel_subscribe_list_id: Option<i32>,
}

impl UpdatePixelSettingsRequest {
    pub fn new(pixel_subscribe_list_id: Option<i32>) -> UpdatePixelSettingsRequest {
